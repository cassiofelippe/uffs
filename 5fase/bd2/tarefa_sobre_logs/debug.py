# o codigo é a princípio para recueprar os dados a partir do arquivo de log 'teste03'
import re;

# importa alguma coisa, algo relacionado à expressões regulares ?

# abre o arquivo de log 'teste03', o usa como 'r'
arquivo = open('teste03', 'r')

# transforma as operações em uma lista ?
arquivolist = list(arquivo)

# tipo de recuperação = UNDO
UNDO = []
...
# seta a var commit como o que encontrar no arquivo de log ??
