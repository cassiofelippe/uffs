...
create table enfermeira (
	...
	constraint fk_enfermeira_enfermeira foreign key (chefe) references enfermeira(cpf),
...
create table convenio (
	...
	constraint fk_convenio_plano foreign key (cnpjplano) references plano(cnpj)
);
